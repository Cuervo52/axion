...
ALTER TABLE competitions ADD COLUMN IF NOT EXISTS created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE competitions ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP;
